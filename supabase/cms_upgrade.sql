...
values
    ...
    ('contact_page_eyebrow', 'عنوان صغير لصفحة التواصل', 'تواصل معنا', 'text', 'صفحة التواصل', 130),
    ('contact_page_title', 'العنوان الكبير لصفحة التواصل', 'نسعد بتواصلكم والإجابة على استفساراتكم ومساعدتكم', 'textarea', 'صفحة التواصل', 131),
    ('contact_calls_title', 'عنوان أوقات المكالمات', 'أوقات استقبال المكالمات:', 'text', 'صفحة التواصل', 132),
    ('contact_calls_text', 'نص أوقات المكالمات', 'من الساعة 8 صباحًا وحتى الساعة 12 عند منتصف الليل', 'textarea', 'صفحة التواصل', 133),
    ('contact_visits_title', 'عنوان أوقات تنسيق الفعاليات', 'أوقات تنسيق الفعاليات:', 'text', 'صفحة التواصل', 134),
    ('contact_visits_text', 'نص أوقات تنسيق الفعاليات', 'من الساعة 4 مساءً وحتى الساعة 11 مساءً على مدار الأسبوع', 'textarea', 'صفحة التواصل', 135),
    ('contact_location_title', 'عنوان الموقع في صفحة التواصل', 'الموقع:', 'text', 'صفحة التواصل', 136),
    ('contact_channel_whatsapp', 'اسم قناة واتساب', 'واتساب المبيعات', 'text', 'صفحة التواصل', 137),
    ('contact_channel_instagram', 'اسم قناة الانستقرام', 'الانستقرام', 'text', 'صفحة التواصل', 138),
    ('social_instagram_label', 'وصف الانستقرام', 'تابع أعمالنا اليومية', 'text', 'صفحة التواصل', 139),
    ('social_instagram_url', 'رابط الانستقرام', '#contact', 'url', 'صفحة التواصل', 140),
    ('contact_channel_x', 'اسم قناة أكس', 'أكس', 'text', 'صفحة التواصل', 141),
    ('social_x_label', 'وصف أكس', 'آخر الأخبار والتحديثات', 'text', 'صفحة التواصل', 142),
    ('social_x_url', 'رابط أكس', '#contact', 'url', 'صفحة التواصل', 143),
    ('contact_channel_youtube', 'اسم قناة اليوتيوب', 'اليوتيوب', 'text', 'صفحة التواصل', 144),
    ('social_youtube_label', 'وصف اليوتيوب', 'مشاهد من الفعاليات', 'text', 'صفحة التواصل', 145),
    ('social_youtube_url', 'رابط اليوتيوب', '#contact', 'url', 'صفحة التواصل', 146),
    ('contact_channel_tiktok', 'اسم قناة تيك توك', 'تيك توك', 'text', 'صفحة التواصل', 147),
    ('social_tiktok_label', 'وصف تيك توك', 'لقطات قصيرة من التجارب', 'text', 'صفحة التواصل', 148),
    ('social_tiktok_url', 'رابط تيك توك', '#contact', 'url', 'صفحة التواصل', 149),
    ('contact_channel_snapchat', 'اسم قناة سناب شات', 'سناب شات', 'text', 'صفحة التواصل', 150),
    ('social_snapchat_label', 'وصف سناب شات', 'تغطيات مباشرة ومقاطع سريعة', 'text', 'صفحة التواصل', 151),
    ('social_snapchat_url', 'رابط سناب شات', '#contact', 'url', 'صفحة التواصل', 152),
    ('contact_channel_email', 'اسم قناة البريد الإلكتروني', 'البريد الإلكتروني', 'text', 'صفحة التواصل', 153),
    ('contact_channel_location', 'اسم قناة الموقع', 'موقعنا', 'text', 'صفحة التواصل', 154),
